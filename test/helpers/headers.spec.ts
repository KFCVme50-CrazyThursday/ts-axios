...
describe('helpers/headers', () => {
    ...
    test('should parse headers', () => {
      const parsed = parseHeaders(
        'Content-Type: application/json\r\n' +
          ...
          'Date:  Mon, 30 Nov 2020 06:52:19 GMT\r\n' +
          ':aa\r\n' +
          'key:'
      )
      ...
      expect(parsed['date']).toBe('Mon, 30 Nov 2020 06:52:19 GMT')
  ...
  describe('processHeaders', () => {
    test('should normalize Content-Type header name', () => {
      const headers: any = {
        'contENT-Type': 'name/age',
        'Content-length': 1024
      }
      processHeaders(headers, {})
      expect(headers['Content-Type']).toBe('name/age')
    ...
    test('should set not Content_type if not set and data is not PlainObject', () => {
      const headers: any = {}
